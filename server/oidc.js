...
//  *
//  * // TODO
// // * Add possiblity to add custom roles
// // * Secure cookie?
//    * Logout function
...
//   /**
//    * Checks if the req.user has this/these roles.
//    *
//    * A role is a property found on the user object and has most
//    * likely been added through the createUser function @see {createUser}
//    *
//    * Usage:
//    * requireRole('isAdmin', 'isEditor')
//    */

//   oidcFunctions.requireRole = (...roles) => (req, res, next) => {
//     const user = req.user || {}
